    ...
    <>
      <div className="flex pt-6 align-items-center desktop:pt-14">
        ...
        <div className="flex items-center ml-auto">
          ...
          >
            ...
            <div
              className={`absolute pt-4 pb-4 pl-4 top-11 -left-4 w-28 rounded-2xl shadow-box  gap-2  
            ...
            >
              <p
                ...
                className=" font-bold text-base font-inter hover:cursor-pointer hover:text-hovervolor"
              >
                Sans Serif
              </p>
              <p
                onClick={() => handlefont("Lora")}
                className=" font-bold text-base font-lora hover:cursor-pointer hover:text-hovervolor"
              >
                Serif
              </p>
              <p
                onClick={() => handlefont("Inconsolata")}
                className=" font-bold text-base font-inconsolata hover:cursor-pointer hover:text-hovervolor"
              >
                Mono
              </p>
            </div>
      ...
      >
        <div
          ...
          }  flex items-center  rounded-2xl overflow-hidden hover:border hover: border-hovervolor md:h-16 md:pt-5 md:pr-6 md:pb-5 md:pl-6 ${
        ...
        >
          <input
            ...
            className={` appearance-none ${
              dark ? "bg-darkinput" : "bg-gray-200"
            } pt-4 pr-6 pb-4 pl-6 border-none outline-none  text-Base font-bold max-w-percent w-9/12 `}
          />
